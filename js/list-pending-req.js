...
(function($) {
  ...
  async function setUpDataOcc() {
    const res = await fetch(url + '/requestsPending/');
      ...
      **/
      ...
      btnVisualizar.addEventListener("click", function() {
        ...
        for (let i = 0; i < selecionados.length; i++) {
          ...
          localStorage.setItem("idreqs", selecionado[0].innerHTML);
      ...
      btnEliminar.addEventListener("click", function() {
        ...
        for (let i = 0; i < selecionados.length; i++) {
          ...
          for (const ln of selecionados) {
            ...
            swal({
                title: "Pretende eliminar este pedido " + selecionado[0].innerHTML + " ?",
              ...
              .then((willDelete) => {
                if (willDelete) {}
                  ...
                  async function setUpDataTable1() {
                    ...
                    await fetch(url + `/requests/` + a, { method: "DELETE" })
                      .then(function(response) {
                        if (!response.ok) {
                          ...
                          swal({
                            title: "O pedido " + selecionado[0].innerHTML + " foi eliminado com sucesso!",
                            icon: "success",
                          });
                          ln.remove();
                        }
